...
type TeamGrid = Record<string, boolean[]>;
            ...
            <tbody>
              {Array.from({ length: ROWS }, (_, r) => (
                <tr key={r}>
                  ...
                  {TEAMS.map((t) => {
                    const done = !!(state.grid[t.abbr]?.[r]);
                    return (
                      <td key={t.abbr} className={`cell ${done ? "cell-done" : ""}`} title={`${t.abbr} — ${r} runs`}>
